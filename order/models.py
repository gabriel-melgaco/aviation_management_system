...
class OrderItem(models.Model):
    ...
    dpe = models.CharField(max_length=100, null=True, blank=True)
    eglog = models.CharField(max_length=100, null=True, blank=True)
    log = models.BooleanField("Log Card", default=False)
    sn_attended = models.CharField(max_length=100, null=True, blank=True)
    expiration_date_attended = models.DateField("Data de Validade do Atendimento", null=True, blank=True)
    nf_answer = models.CharField("Nota Fiscal de Atendimento", max_length=255, null=True, blank=True)
    ...
    gmm = models.CharField(max_length=100, null=True, blank=True)
    bms = models.CharField(max_length=100, null=True, blank=True)
    hb_destination = models.CharField("Destino HB", max_length=100, null=True, blank=True)
